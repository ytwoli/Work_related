...
f_source1 = FileSource(
    path=r"breast_cancer/data/data_df1.parquet",
...
f_source2 = FileSource(
    path=r"breast_cancer/data/data_df2.parquet",
    event_timestamp_column="event_timestamp"
)
...
f_source3 = FileSource(
    path=r"breast_cancer/data/data_df3.parquet",
    event_timestamp_column="event_timestamp"
)
...
f_source4 = FileSource(
    path=r"breast_cancer/data/data_df4.parquet",
    event_timestamp_column="event_timestamp"
)
...
target_source = FileSource(
    path=r"breast_cancer/data/target_df.parquet", 
